...
export function RestaurantDashboard({ userProfile }: { userProfile: UserProfile | null }) {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case "swaps":       return <div className="max-w-5xl mx-auto"><SwapRequests /></div>
      case "taxi":        return <TaxiManagement />
      case "staff":       return <StaffDirectory />
      case "shortage":    return <div className="max-w-4xl mx-auto"><ShortageAlerts /></div>
      case "users":       return <div className="max-w-5xl mx-auto"><UserManagement /></div>
      case "branches":    return <div className="max-w-5xl mx-auto"><BranchManagement /></div>
      case "settings":    return <div className="max-w-6xl mx-auto"><h2 className="text-2xl font-bold mb-6">Settings &amp; Roles</h2><RoleManagement /></div>
      ...
      <header className="sticky top-0 z-40 w-full border-b border-border/40 bg-background/80 backdrop-blur-xl supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 max-w-screen-2xl items-center justify-between px-4 md:px-8 mx-auto">
          ...
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-xl overflow-hidden shadow-lg shadow-primary/20 shrink-0">
              <Image src="/Logo.jpg" alt="REMO" width={40} height={40} className="object-cover w-full h-full" />
            </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <select
                ...
                className="bg-transparent border-none text-xs text-muted-foreground outline-none cursor-pointer hover:text-foreground transition-colors"
              >
        ...
        <header className="mb-8 flex justify-between items-end">
          ...
          {userProfile && (
            <div className="hidden md:flex flex-col items-end">
              ...
              <span className="text-xs px-2 py-0.5 bg-primary/20 text-primary rounded-full mt-1">{userProfile.role}</span>
            </div>
          )}
        </header>
